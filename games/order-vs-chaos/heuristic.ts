// games/order-vs-chaos/heuristic.ts — optional per-game eval for minimax/greedy bots (plan §3:
...
import type { OrderVsChaosState } from "./engine";

export function heuristic(_state: OrderVsChaosState, _player: PlayerId): number {
  return 0;
}
