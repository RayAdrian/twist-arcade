  ...
  announce(ev: GameEvent<__PASCAL_ID__State>): string {
    ...
    switch (ev.kind) {
      ...
      case "imminent":
        return "";
      case "boardSummary":
        return `Counter is ${ev.view.counter}.`;
      case "status":
        return "";
    }
  },
